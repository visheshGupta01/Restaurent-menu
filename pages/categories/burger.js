...
const Burger = ({ addToCart, products }) => {
  return (
    <div className="">
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto lg:mx-12">
          <div className="flex flex-wrap -m-4 justify-center">
            {Object.keys(products).length === 0&& <p className="font-bold text-2xl">No food items present at the time. Will be available soon. Stay tuned!!</p>}
